...
public class TaskPanel extends javax.swing.JPanel {
    ...
    protected void paintComponent( Graphics g ) {
        ...
        Color firstColor = baseColor.brighter();
        Color secondColor = baseColor.darker();
